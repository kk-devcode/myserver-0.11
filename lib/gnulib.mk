...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libgnu --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --no-conditional-dependencies --libtool --macro-prefix=gl accept argp bind c++defs chdir-long close connect crypto/md5 crypto/sha1 fsync fts getaddrinfo getcwd gethostname getopt-gnu getpeername getsockname getsockopt gettext gettimeofday git-version-gen ioctl listen lseek malloc mkostemp mktime nproc open pipe read-file readlink recv recvfrom regex remove rename select send sendto setsockopt shutdown sigpipe snprintf socket sysexits unlink write
...
libgnu_la_SOURCES += cycle-check.c
...
libgnu_la_SOURCES += opendir-safer.c
...
EXTRA_libgnu_la_SOURCES += fts-cycle.c fts.c
...
EXTRA_libgnu_la_SOURCES += remove.c
